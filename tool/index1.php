...
//$_SESSION['id']="";
if(isset($_SESSION['id']) && $_SESSION['statu']=="管理者"){    //preg_match("/^(m0)/",$_SESSION['id'])
    ...
    <body>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">更改會員資料</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="#" method="post">
            <div class="modal-body" align="center">
                id: <input type="text" name="id" id="id" value="" readonly/><br>
                帳號: <input type="text" name="uid" id="uid" value=""/><br>
                姓名: <input type="text" name="name1" id="name1" value=""/><br>
                信箱: <input type="text" name="eamil" id="email" value=""/><br>
                職位: 
                <?php
                ...
                echo '</select>';
                ?><br>
                生日: <input type="date" name="bd" id="bd" value=""/><br>
                性別: <?php
                        ...
                        echo '</select>';
                        ?>
                電話: <input type="text" name="phone" id="phone" value=""/><br>
            </div>
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" method=post>
                ...
                <label class="control-label p-2">刪除代碼為:<?php $a=number(); echo $a; ?>(6位隨機亂數)</label>
    ...
    <script>
        ...
        $("#userupdata").on("click", function() {
            ...
            if (uid!="" && id !="" && email != '' && name1!="" && statu!="請選擇身分" && bd !="" && sex !="請選擇性別" && phone !="") {
                //alert(uid+" "+id+" "+email+" "+name1+" "+statu+" "+bd+" "+sex+" "+phone);
                $.ajax({
                type: "POST",
                url: "tool1.php",
                data: {
